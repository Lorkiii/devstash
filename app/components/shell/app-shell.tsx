...
function ShellFrame({ children }: ShellFrameProps) {
  ...
  return (
    <div className="devstash-app-shell relative h-dvh flex flex-col text-foreground overflow-hidden">
      ...
      <div className="relative z-10 flex flex-1 min-h-0">
        ...
        <main className="flex-1 min-w-0 min-h-0 overflow-y-auto">
          ...
          {isUnlocked ? (
            <div className="w-full px-3 py-3 sm:px-5 sm:py-4 lg:px-6 lg:py-5">{children}</div>
          ) : (
