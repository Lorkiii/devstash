    ...
    <form onSubmit={handleSubmit} aria-busy={isSaving} className="space-y-3 sm:space-y-4">
        {fixedProject ? (
          <div>
            ...
            <div className="min-h-10 rounded-lg border border-accent/18 bg-background/45 px-2.5 py-1.5 text-[13px] text-foreground/72 sm:min-h-11 sm:px-3 sm:py-2 sm:text-sm">
              {fixedProject.name}
            </div>
        ...
        <label className="block">
          <span className="mb-1 block text-[9px] tracking-widest text-muted-foreground sm:mb-1.5 sm:text-[10px]">SECRET VALUE</span>
          <span className="flex rounded-lg border border-accent/25 bg-background/80 focus-within:border-accent/70 focus-within:ring-2 focus-within:ring-accent/10">
            <input
              ...
              required
              disabled={isSaving}
              className="min-w-0 flex-1 bg-transparent px-2.5 py-1.5 font-mono text-[13px] text-foreground outline-none disabled:opacity-60 sm:px-3 sm:py-2 sm:text-sm"
            />
            <button
              type="button"
              ...
              className="inline-flex min-h-10 min-w-10 items-center justify-center px-2.5 text-accent hover:text-accent disabled:opacity-50 sm:min-h-11 sm:min-w-11 sm:px-3"
            >
        ...
        <label className="block">
          <span className="mb-1 block text-[9px] tracking-widest text-muted-foreground sm:mb-1.5 sm:text-[10px]">NOTES · OPTIONAL</span>
          <textarea
            value={notes}
        ...
        <label className="block">
          ...
          <input
            ...
            className={FIELD_CLASS}
          />
          <span className="mt-1 block text-[9px] text-subtle-foreground sm:text-[10px]">
