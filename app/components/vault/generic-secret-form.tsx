  ...
  return (
    <form onSubmit={handleSubmit} aria-busy={isSaving} className="space-y-4">
        ...
        <label className="block">
          ...
          <span className="flex rounded-lg border border-[#6ea8ff]/25 bg-[#05070d]/80 focus-within:border-[#6ea8ff]/70 focus-within:ring-2 focus-within:ring-[#6ea8ff]/10">
            <input
            ...
            <button
              ...
              className="inline-flex min-h-11 min-w-11 items-center justify-center px-3 text-[#6ea8ff]/70 hover:text-[#6ea8ff] disabled:opacity-50"
            >
