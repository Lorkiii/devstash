...
const COLOR_CLASSES: Record<TaskCategoryColorToken, string> = {
  ...
  emerald: "border-emerald-400/45 bg-emerald-400/10 text-emerald-700 dark:text-emerald-200",
  amber: "border-amber-400/45 bg-amber-400/10 text-amber-700 dark:text-amber-200",
  rose: "border-rose-400/45 bg-rose-400/10 text-rose-700 dark:text-rose-200",
  slate: "border-slate-400/40 bg-slate-400/10 text-slate-700 dark:text-slate-200",
};
